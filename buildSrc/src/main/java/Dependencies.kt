...
//    const val applicationId = "com.wikipedia.app"
...
object Versions {
    ...
    const val lifecycle_runtime_viewmodel_livedata_version = "2.6.0"
    const val lifecycle_extension_version = "2.2.0"
    const val coroutines_version = "1.4.2"
    const val dagger_hilt_version = "2.44.1"
    ...
    const val stdlib_version = "1.8.10"
}
